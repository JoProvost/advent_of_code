...
class TestPart1(unittest.TestCase):
    ...
    def test_sample(self):
        ...
        for line in sample:
            day_8.run(registers, *line.split())

        self.assertEqual(1, last(sorted(registers.values())))
    ...
    def test_challenge(self):
        ...
        self.assertEqual(5102, last(sorted(registers.values())))
...
class TestPart2(unittest.TestCase):
    ...
    def test_challenge(self):
        ...
        for line in challenge:
            day_8.run(registers, *line.split())
        self.assertEqual(6056, registers["highest"])
