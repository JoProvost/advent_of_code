...
class TestPart1(unittest.TestCase):
    ...
    def test_simple_matches(self):
        self.assertEqual(8, day_2.checksum(((5, 1, 9, 5),)))
        self.assertEqual(18, day_2.checksum((
            (5, 1, 9, 5),
            (7, 5, 3),
            (2, 4, 6, 8),
        )))
    ...
    def test_challenge(self):
        self.assertEqual(42378, day_2.checksum(challenge))
...
class TestPart2(unittest.TestCase):
    ...
    def test_simple_matches(self):
        self.assertEqual(4, day_2.checksum_divide(((5, 9, 2, 8),)))
        self.assertEqual(9, day_2.checksum_divide((
            (5, 9, 2, 8),
            (9, 4, 7, 3),
            (3, 8, 6, 5),
        )))
    ...
    def test_challenge(self):
        self.assertEqual(246, day_2.checksum_divide(challenge))
