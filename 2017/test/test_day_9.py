...
with open(os.path.join(os.path.dirname(__file__), 'challenge_day_9.txt')) as f:
    challenge = f.read()
...
class TestPart1(unittest.TestCase):
    ...
    def test_sample(self):
        ...
        self.assertEqual(1, day_9.parse('{}'))
        self.assertEqual(2, day_9.parse('{}{}'))
        self.assertEqual(5, day_9.parse('{{}{}}'))
        self.assertEqual(1, day_9.parse('{<{}>}'))
        self.assertEqual(3, day_9.parse('{!<{}>}'))
        self.assertEqual(3, day_9.parse('{{<!>},{<!>},{<!>},{<a>}}'))

    def test_challenge(self):
        self.assertEqual(10820, day_9.parse(challenge))
...
class TestPart2(unittest.TestCase):
    ...
    def test_sample(self):
        self.assertEqual((0, 0), day_9.parse_with_garbage('<>'))
        self.assertEqual((0, 17), day_9.parse_with_garbage('<random characters>'))
        self.assertEqual((0, 3), day_9.parse_with_garbage('<<<<>'))
        self.assertEqual((0, 2), day_9.parse_with_garbage('<{!>}>'))
        self.assertEqual((0, 0), day_9.parse_with_garbage('<!!>'))
        self.assertEqual((0, 0), day_9.parse_with_garbage('<!!!>>'))
        self.assertEqual((0, 10), day_9.parse_with_garbage('<{o"i!a,<{i<a>'))

    def test_challenge(self):
        self.assertEqual((10820, 5547), day_9.parse_with_garbage(challenge))
