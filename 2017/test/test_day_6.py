...
import day_6
from util import count, last

challenge = (4, 10, 4, 1, 8, 4, 9, 14, 5, 1, 14, 15, 0, 15, 3, 5)
...
class TestPart1(unittest.TestCase):
    ...
    def test_steps(self):
        self.assertEqual((2, 4, 1, 2), day_6.redistribution((0, 2, 7, 0)))
        self.assertEqual((3, 1, 2, 3), day_6.redistribution((2, 4, 1, 2)))
        self.assertEqual((0, 2, 3, 4), day_6.redistribution((3, 1, 2, 3)))
        self.assertEqual((1, 3, 4, 1), day_6.redistribution((0, 2, 3, 4)))
        self.assertEqual((1, 1, 0, 1), day_6.redistribution((0, 0, 3, 0)))
        self.assertEqual((0, 0, 0, 1, 1, 1), day_6.redistribution((0, 0, 3, 0, 0, 0)))

    def test_loop_detection(self):
        self.assertEqual(5, count(day_6.loop((0, 2, 7, 0))))
