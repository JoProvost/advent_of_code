...
class TestPart1(unittest.TestCase):
    ...
    def test_puzzle(self):
        with open(join(dirname(__file__), 'resources', 'grid_computing.txt')) as f:
            puzzle_input = f.read()
        grid = NodeGrid()
        grid.configure(puzzle_input)
        self.assertEqual(924, grid.viable_pairs())
