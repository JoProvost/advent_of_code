...
from balance_bots import MicrochipsFactory
...
class TestPart1(unittest.TestCase):
    ...
    def test_sample_data(self):
        ...
        factory = MicrochipsFactory()
        factory.execute(puzzle)
        self.assertEqual('bot 2', factory.who_was_responsible_for(2, 5))

    def test_puzzle_input(self):
        with open(join(dirname(__file__), 'resources', 'balance_bots.txt')) as f:
            puzzle_input = f.read()
        factory = MicrochipsFactory()
        factory.execute(puzzle_input)
        self.assertEqual('bot 161', factory.who_was_responsible_for(17, 61))
...
class TestPart2(unittest.TestCase):
    ...
    def test_puzzle_input(self):
        ...
        self.assertEqual(
            133163,
            factory.consumers['output 0'].microchips[0] *
            factory.consumers['output 1'].microchips[0] *
            factory.consumers['output 2'].microchips[0])
