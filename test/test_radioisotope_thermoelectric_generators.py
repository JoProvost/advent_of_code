...
from radioisotope_thermoelectric_generators import *
...
class TestPart1(unittest.TestCase):
    ...
    def test_data_structure(self):
        ...
        hash_set = {Microchip('AA'), Generator('BB'), Floor(), Elevator(), RadioisotopeTestingFacility([])}

    def test_simplest_happy_path(self):
        facility = RadioisotopeTestingFacility(
            floors=(
                Floor((
                    Generator('nikel'),
                    Microchip('nikel')
