...
class TestPart1(unittest.TestCase):
    ...
    def test_example(self):
        ...
        self.assertTrue(sculpture.will_you_get_a_capsule_at(time=5))

        self.assertFalse(sculpture.will_you_get_a_capsule_at(time=4))
        self.assertFalse(sculpture.will_you_get_a_capsule_at(time=3))
        self.assertFalse(sculpture.will_you_get_a_capsule_at(time=2))
        self.assertFalse(sculpture.will_you_get_a_capsule_at(time=1))
        self.assertFalse(sculpture.will_you_get_a_capsule_at(time=0))
    ...
    def test_puzzle(self):
        ...
        right_timing = next(time for time in range(1000000)
