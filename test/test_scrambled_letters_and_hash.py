...
class TestPart1(unittest.TestCase):
    ...
    def test_example(self):
        s = StringManipulator('abcde')
        s.transform('swap position 4 with position 0')
        self.assertEqual('ebcda', s.string)

        s.transform('swap letter d with letter b')
        self.assertEqual('edcba', s.string)

        s.transform('rotate left 1 step')
        self.assertEqual('dcbae', s.string)

        s.transform('move position 1 to position 4')
        self.assertEqual('dbaec', s.string)

        s.transform('move position 3 to position 0')
        self.assertEqual('edbac', s.string)

        s.transform('rotate based on position of letter b')
        self.assertEqual('baced', s.string)

        s.transform('rotate based on position of letter d')
        self.assertEqual('dbace', s.string)
