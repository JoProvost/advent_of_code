...
class TestPart1(unittest.TestCase):
    ...
    produce a new string which is exactly half as long as the original. If
    the length of the checksum is even, repeat the process until you end up
    with a checksum with an odd length.
    ...
    def test_example(self):
        self.assertEqual('100', dragon_curve('1'))
        self.assertEqual('001', dragon_curve('0'))
        self.assertEqual('11111000000', dragon_curve('11111'))
        self.assertEqual('1111000010100101011110000', dragon_curve('111100001010'))

        self.assertEqual('01100', checksum('10000011110010000111'))
        self.assertEqual('10000011110010000111', fill_space('10000', 20))

        self.assertEqual('01100', checksum(fill_space('10000', 20)))

    def test_puzzle(self):
        self.assertEqual('10010010110011010', checksum(fill_space('01000100010010111', 272)))
...
class TestPart2(unittest.TestCase):
    ...
    def test_puzzle(self):
        self.assertEqual('01010100101011100', checksum(fill_space('01000100010010111', 35651584)))
